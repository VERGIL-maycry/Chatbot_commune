...
qa_pairs = [
    # Acte de naissance
    {
        ...
        <ul>
            <li>
                <div class="french-text">Formulaire de demande rempli et signé</div>
                <div class="arabic-text">استمارة الطلب معبأة وموقعة</div>
            </li>
            <li>
                <div class="french-text">Pièce d'identité du demandeur</div>
                <div class="arabic-text">بطاقة التعريف الوطنية للمتقدم</div>
            </li>
            <li>
                <div class="french-text">Livret de famille (si disponible)</div>
                <div class="arabic-text">دفتر الحالة المدنية (إن وجد)</div>
            </li>
            <li>
    ...
    # Certificat de résidence
    {
        ...
        <ul>
            ...
            <li>
                <div class="french-text">Pièce d'identité nationale</div>
                <div class="arabic-text">البطاقة الوطنية للتعريف</div>
            </li>
            <li>
                <div class="french-text">Justificatif de domicile (facture d'eau, électricité, téléphone)</div>
                <div class="arabic-text">وثيقة تثبت العنوان (فاتورة ماء، كهرباء، هاتف)</div>
            </li>
            <li>
                <div class="french-text">Contrat de location ou titre de propriété (si applicable)</div>
                <div class="arabic-text">عقد الإيجار أو سند الملكية (إن وجد)</div>
            </li>
            <li>
    ...
    # Adresse de la mairie
    {
        ...
        <div class="address-item">
            <div class="french-text"><strong>Commune de Fès</strong></div>
            <div class="arabic-text"><strong>جماعة فاس</strong></div>
        </div>
        <div class="address-item">
            <div class="french-text">Hôtel de Ville de Fès</div>
            <div class="arabic-text">بلدية فاس</div>
        </div>
        <div class="address-item">
    ...
    # Carte nationale d'identité
    {
        ...
        <ul>
            <li>
                <div class="french-text">Extrait d'acte de naissance récent (moins de 3 mois)</div>
                <div class="arabic-text">نسخة موجزة من عقد الازدياد حديثة (أقل من 3 أشهر)</div>
            </li>
            <li>
                <div class="french-text">4 photos d'identité récentes, en couleur, sur fond blanc</div>
                <div class="arabic-text">أربع صور فوتوغرافية حديثة ملونة بخلفية بيضاء</div>
            </li>
            <li>
                <div class="french-text">Certificat de résidence</div>
                <div class="arabic-text">شهادة السكنى</div>
            </li>
            <li>
                <div class="french-text">Ancienne carte d'identité (en cas de renouvellement)</div>
                <div class="arabic-text">البطاقة الوطنية القديمة (في حالة التجديد)</div>
            </li>
            <li>
                <div class="french-text">Timbres fiscaux (30 dirhams)</div>
                <div class="arabic-text">طوابع ضريبية (30 دراهم)</div>
            </li>
        </ul>
    ...
    # Taxes municipales
    {
        ...
        <div class="section-title">
            <div class="french-text"><strong>Lieu de paiement :</strong></div>
            <div class="arabic-text"><strong>مكان الدفع :</strong></div>
        </div>
        <ul>
            <li>
                <div class="french-text">Service des finances de la commune</div>
                <div class="arabic-text">مصلحة المالية بالجماعة</div>
            </li>
            <li>
                <div class="french-text">En ligne (si disponible)</div>
                <div class="arabic-text">عبر الإنترنت (إن وجد)</div>
            </li>
            <li>
                <div class="french-text">Guichet automatique</div>
                <div class="arabic-text">الصراف الآلي</div>
            </li>
        </ul>
    ...
    # Rendez-vous
    {
        ...
        <div class="section-title">
            <div class="french-text"><strong>Méthodes disponibles :</strong></div>
            <div class="arabic-text"><strong>الطرق المتاحة :</strong></div>
        </div>
        <ul>
            <li>
                <div class="french-text">Par téléphone : Service d'accueil</div>
                <div class="arabic-text">بالهاتف : مكتب الاستقبال</div>
            </li>
            <li>
                <div class="french-text">Sur place : Guichet d'accueil</div>
                <div class="arabic-text">في المكان : مكتب الاستقبال</div>
            </li>
            <li>
                <div class="french-text">En ligne : Site web de la commune</div>
                <div class="arabic-text">عبر الإنترنت : موقع الجماعة</div>
            </li>
        </ul>
    ...
    # Extrait de mariage
    {
        ...
        <ul>
            ...
            <li>
                <div class="french-text">Informations sur le mariage (date, lieu, noms des époux)</div>
                <div class="arabic-text">معلومات عن الزواج (التاريخ، المكان، أسماء الزوجين)</div>
            </li>
            <li>
                <div class="french-text">Livret de famille (si disponible)</div>
                <div class="arabic-text">دفتر الحالة المدنية (إن وجد)</div>
    ...
    # Services en ligne
    {
        ...
        <ul>
            <li>
                <div class="french-text">Demande d'actes d'état civil</div>
                <div class="arabic-text">طلب وثائق الحالة المدنية</div>
            </li>
            <li>
                <div class="french-text">Paiement des taxes municipales</div>
                <div class="arabic-text">دفع الضرائب الجماعية</div>
            </li>
            <li>
                <div class="french-text">Prise de rendez-vous</div>
                <div class="arabic-text">حجز المواعيد</div>
            </li>
            <li>
                <div class="french-text">Consultation des horaires</div>
                <div class="arabic-text">استشارة الأوقات</div>
            </li>
            <li>
                <div class="french-text">Téléchargement de formulaires</div>
                <div class="arabic-text">تحميل الاستمارات</div>
            </li>
        </ul>
    ...
    {
        "questions": [
            "comment obtenir un certificat de décès", "certificat de décès", "certificat décès", "certif décès", "certificat deces", "شهادة الوفاة", "شهادة وفاة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande rempli et signé</div><div class='arabic-text'>استمارة الطلب معبأة وموقعة</div></li>
            <li><div class='french-text'>Pièce d'identité du déclarant</div><div class='arabic-text'>بطاقة تعريف المصرح</div></li>
            <li><div class='french-text'>Certificat médical de décès</div><div class='arabic-text'>شهادة طبية للوفاة</div></li>
        </ul>
        </div>"""
    },
    # Permis de conduire
    {
        "questions": [
            "comment obtenir un permis de conduire", "permis de conduire", "permis conduire", "permis", "رخصة السياقة", "رخصة القيادة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Pièce d'identité nationale</div><div class='arabic-text'>البطاقة الوطنية للتعريف</div></li>
            <li><div class='french-text'>Certificat médical</div><div class='arabic-text'>شهادة طبية</div></li>
            <li><div class='french-text'>Photos d'identité</div><div class='arabic-text'>صور فوتوغرافية</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment faire une déclaration de travaux", "déclaration de travaux", "travaux", "تصريح بالأشغال", "تصريح أشغال"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de déclaration</div><div class='arabic-text'>استمارة التصريح</div></li>
            <li><div class='french-text'>Plan des travaux</div><div class='arabic-text'>مخطط الأشغال</div></li>
            <li><div class='french-text'>Autorisation préalable (si nécessaire)</div><div class='arabic-text'>رخصة مسبقة (إن وجدت)</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir un certificat d'urbanisme", "certificat d'urbanisme", "certificat urbanisme", "شهادة التعمير", "شهادة العمران"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Plan de situation</div><div class='arabic-text'>مخطط الموقع</div></li>
            <li><div class='french-text'>Titre de propriété</div><div class='arabic-text'>سند الملكية</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir une autorisation de stationnement", "autorisation de stationnement", "autorisation stationnement", "رخصة الوقوف", "رخصة التوقف"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Justificatif d'adresse</div><div class='arabic-text'>إثبات العنوان</div></li>
            <li><div class='french-text'>Carte grise du véhicule</div><div class='arabic-text'>بطاقة رمادية للمركبة</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir un certificat de conformité", "certificat de conformité", "certificat conformité", "شهادة المطابقة", "شهادة مطابقة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Rapport technique</div><div class='arabic-text'>تقرير تقني</div></li>
            <li><div class='french-text'>Photos des travaux réalisés</div><div class='arabic-text'>صور الأشغال المنجزة</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir une attestation de domiciliation", "attestation de domiciliation", "attestation domiciliation", "شهادة الإقامة", "شهادة السكن"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Justificatif de domicile</div><div class='arabic-text'>إثبات السكنى</div></li>
    ...
    {
        "questions": [
            "comment obtenir une copie d'acte", "copie d'acte", "copie acte", "نسخة من الوثيقة", "نسخة وثيقة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Indication du type d'acte</div><div class='arabic-text'>تحديد نوع الوثيقة</div></li>
            <li><div class='french-text'>Pièce d'identité</div><div class='arabic-text'>بطاقة التعريف</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment légaliser une signature", "légalisation de signature", "legalisation signature", "تصديق الإمضاء", "تصديق التوقيع"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Document à légaliser</div><div class='arabic-text'>الوثيقة المراد تصديقها</div></li>
            <li><div class='french-text'>Pièce d'identité</div><div class='arabic-text'>بطاقة التعريف</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir un certificat de nationalité", "certificat de nationalité", "certificat nationalité", "شهادة الجنسية", "شهادة الوطنية"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
        <ul>
            <li><div class='french-text'>Formulaire de demande</div><div class='arabic-text'>استمارة الطلب</div></li>
            <li><div class='french-text'>Extrait d'acte de naissance</div><div class='arabic-text'>نسخة من عقد الازدياد</div></li>
            <li><div class='french-text'>Pièce d'identité</div><div class='arabic-text'>بطاقة التعريف</div></li>
        </ul>
        </div>"""
    },
    ...
    {
        "questions": [
            "comment obtenir une attestation de résidence", "attestation de résidence", "attestation résidence", "شهادة السكنى", "شهادة الإقامة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
    ...
    {
        "questions": [
            "comment obtenir un certificat de célibat", "certificat de célibat", "certificat célibat", "شهادة العزوبة", "شهادة عزوبة"
        ],
        "answer": """<div class='answer-section'>
        <h4>Documents requis</h4>
        <h4 class='arabic-title'>الوثائق المطلوبة</h4>
...
def get_follow_up_question(intent, step=1):
    follow_ups = {
        ...
        <div class="arabic-text">ما نوع عقد الازدياد الذي تحتاجه؟</div>
        <ul>
            <li>
                <div class="french-text">Extrait simple</div>
                <div class="arabic-text">نسخة بسيطة</div>
            </li>
            <li>
                <div class="french-text">Copie intégrale</div>
                <div class="arabic-text">نسخة كاملة</div>
            </li>
            <li>
                <div class="french-text">Acte avec mentions marginales</div>
                <div class="arabic-text">عقد مع إشارات هامشية</div>
            </li>
        </ul>
    </div>"""
        },
        ...
        <h4 class="arabic-title">نوع الطلب</h4>
        <div class="french-text">S'agit-il d'une première demande ou d'un renouvellement ?</div>
        <div class="arabic-text">هل هي طلب أولي أم تجديد؟</div>
    </div>"""
        },
        'passport': {
            1: """<div class="answer-section">
        ...
        <h4 class="arabic-title">مدة السكنى</h4>
        <div class="french-text">Habitez-vous à cette adresse depuis plus de 6 mois ?</div>
        <div class="arabic-text">هل تسكن في هذا العنوان منذ أكثر من 6 أشهر؟</div>
    </div>"""
        },
        'marriage': {
            1: """<div class="answer-section">
        <h4>Type de mariage</h4>
        <h4 class="arabic-title">نوع الزواج</h4>
        <div class="french-text">S'agit-il d'un mariage civil ou religieux ?</div>
        <div class="arabic-text">هل هو زواج مدني أم ديني؟</div>
    </div>"""
        },
        'taxes': {
            1: """<div class="answer-section">
        <h4>Type de taxes</h4>
        <h4 class="arabic-title">نوع الضرائب</h4>
        <div class="french-text">Quel type de taxes souhaitez-vous payer ?</div>
        <div class="arabic-text">ما نوع الضرائب التي تريد دفعها؟</div>
    </div>"""
        },
        'business': {
            1: """<div class="answer-section">
        <h4>Type de commerce</h4>
        <h4 class="arabic-title">نوع المحل التجاري</h4>
        <div class="french-text">Quel type de commerce souhaitez-vous ouvrir ?</div>
        <div class="arabic-text">ما نوع المحل التجاري الذي تريد فتحه؟</div>
    </div>"""
        },
        'appointment': {
            1: """<div class="answer-section">
        <h4>Service demandé</h4>
        <h4 class="arabic-title">الخدمة المطلوبة</h4>
